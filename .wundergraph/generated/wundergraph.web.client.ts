...
export class Client {
	...
	private readonly applicationHash: string = "cf114f9c";
	private readonly applicationPath: string = "api/main";
	private readonly sdkVersion: string = "1.0.0-next.5";
	...
	public login: Record<AuthProviderId, AuthProvider["login"]> = {
		...
		test: (redirectURI?: string): void => {
			this.startLogin(AuthProviderId.test, redirectURI);
		},
	};
	public authProviders: Array<AuthProvider> = [
		...
		{
			id: AuthProviderId.test,
			login: this.login[AuthProviderId.test],
		},
	];
